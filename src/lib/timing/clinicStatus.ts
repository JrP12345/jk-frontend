...
export function getClinicOperationalStatus(
  ...
  if (is24x7) {
    return {
      ...
      badgeBgClass: "bg-emerald-50 dark:bg-emerald-950/40 border-emerald-200 dark:border-emerald-800",
      isOpen: true,
    };
  }
  ...
  if (todaySlots.length === 0) {
    ...
    return {
      ...
      badgeBgClass: "bg-zinc-100 dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700",
      isOpen: false,
    ...
    if (currentMinutes >= slot.startMinutes && currentMinutes < slot.endMinutes) {
      ...
      if (minutesRemaining <= 30) {
        return {
          ...
          badgeBgClass: "bg-amber-50 dark:bg-amber-950/40 border-amber-200 dark:border-amber-800",
          isOpen: true,
